...
public class CouponController extends BaseController {
    ...
    public String add_view(HttpServletRequest request ,Model model) {
    	...
    	List<Map<String, Object>> list = couponServiceImpl.getCouponByType("Gift",ShiroKit.getUser().getDeptId());
    	model.addAttribute("GiftCoupon", list);
...
//    	}
    ...
    public Object list(String condition) {
    	List<Map<String, Object>> result = couponServiceImpl.list(condition,"Cash",ShiroKit.getUser().getDeptId());
...
//	    		stock += weixinServiceImpl.codeDeposit(coupon,strArray,access_token);
