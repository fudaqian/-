...
public class RoleController extends BaseController {
    ...
    public Object list(@RequestParam(required = false) String roleName) {
        ...
        List<Map<String, Object>> roles = this.roleService.selectRoles(super.getPara("roleName"),nowadminid);
    ...
    public Tip add(@Valid Role role, BindingResult result) {
        ...
        Role roleFather = roleService.selectById(role.getPid());
    ...
    public List<ZTreeNode> roleTreeList() {
    	Integer nowadminid = ShiroKit.getUser().getRoleList().get(0);
        List<ZTreeNode> roleTreeList = this.roleService.roleTreeList(nowadminid);
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable Integer userId) {
        ...
        if (ToolUtil.isEmpty(roleid)) {
            ...
            List<ZTreeNode> roleTreeListByUserId = this.roleService.roleTreeListByRoleId(strArray,nowadminid);
